...
class OntologyDatatypeProperty(name : String, labels : Map[Language, String], comments : Map[Language, String],
                               domain : OntologyClass, override val range : Datatype,
    ...
    extends OntologyProperty(name, labels, comments, domain, range, equivalentProperties,
      disjointWithProperties, rdfTypes )
